...
export const GmailBlock: BlockConfig<GmailToolResponse> = {
  ...
  outputs: {
    ...
    has_attachments: { type: 'string', description: 'Whether email has attachments (true/false)' },
    attachments: { type: 'string', description: 'JSON array of attachment information' },
    raw_email: {
      type: 'string',
